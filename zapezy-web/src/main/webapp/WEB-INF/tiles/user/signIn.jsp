...
<form id="login_form" name="f" action="${pageContext.servletContext.contextPath}/<c:url value='j_spring_security_check' />" method='POST' class="eform">
    ...
    <div>
        <a href="${pageContext.servletContext.contextPath}/user/signUp"><spring:message code="label.register_user"/></a>
        <a href="${pageContext.servletContext.contextPath}/user/forgotPassword"><spring:message code="label.forgot_password"/></a>
    </div>
    <a href="${pageContext.servletContext.contextPath}/social/facebook/signin" id="facebooksignin">
